...
icu_build_path="$arkui_root_path/out/arkui-cross_ios_arm64/icu_data"
icu_host_install_path="$arkui_root_path/out/arkui-cross_ios_arm64/clang_x64/libicudata/ios"
icu_ios_install_path="$arkui_root_path/out/arkui-cross_ios_arm64/libicudata/ios"
...
build_for_ios() {
    ...
    if [ $icu_data_library_type = "shared" ]; then
        cp -r lib/libicudata.69.1.dylib $icu_ios_install_path/libicudata.69.1.dylib
    else
...
echo "[ICUData] android ios success."
exit 0

...
private:
    ...
    WmErrorCode ProcessLifeCycleEventRegister(
        sptr<JsWindowListener> listener, std::shared_ptr<OHOS::Rosen::Window> window, bool isRegister);
    WmErrorCode ProcessSizeChangeRegister(
        sptr<JsWindowListener> listener, std::shared_ptr<Window> window, bool isRegister);
    using Func_t = WmErrorCode(JsWindowRegisterManager::*)(
        sptr<JsWindowListener>, std::shared_ptr<OHOS::Rosen::Window> window, bool);

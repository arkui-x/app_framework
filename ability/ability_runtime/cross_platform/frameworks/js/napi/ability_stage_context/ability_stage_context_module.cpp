...
static napi_module_with_js _module = {
    ...
    .nm_get_js_code = (GetJSCodeCallback)NAPI_application_AbilityStageContext_GetJSCode,
    .nm_get_abc_code = (GetJSCodeCallback)NAPI_application_AbilityStageContext_GetABCCode,
};
